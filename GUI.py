...
class GraphIsomorphismCheckerApp(ctk.CTk):
    def __init__(self):
        ...
        graph_frame_width = graph_frame_height = 500
        controls_width = 200
        log_height = 350
        ...
        self.combobox_1 = ctk.CTkComboBox(self.frame_controls, values=["", "", ""])
        self.combobox_1.grid(row=2, column=0, padx=(10,10), pady=(0,10), sticky="nsew")
        self.button_check = ctk.CTkButton(self.frame_controls, text="Проверить на изоморфизм", command=self.check_isomorphism, fg_color="green")
